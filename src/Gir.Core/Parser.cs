...
namespace Gir
{
    public static class Parser
    {
        ...
        public static IEnumerable<Repository> Parse(Stream stream, string includeDir, out Repository mainRepository)
        {
            var serializer = new XmlSerializer(typeof(Repository));
            mainRepository = (Repository)serializer.Deserialize(stream);
